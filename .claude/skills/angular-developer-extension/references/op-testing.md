...
**Auch laden:** `angular-developer` für TestBed, HttpTestingController, Harnesses, Router-Tests und async-Patterns.
...
- `angular-refactor` Skill — Unterscheidung Integration/Behavior vs. Unit specs beim Refactoring
