...
**Ladereihenfolge:** Erst `angular-new-app` (Basis-CLI-Schritte); dann diese Extension (striktere Orchestrierung + Freigaben).

**Rolle:** Orchestrierung, keine direkte Implementierung. Subagent erhält nur enge, nutzerfreigegebene Aufgaben.

## Voraussetzungen

- Basis-Skill `angular-new-app` muss geladen sein.
