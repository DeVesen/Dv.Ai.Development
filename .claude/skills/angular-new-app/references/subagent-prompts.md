# Subagent templates (Angular New App)
...
If the user opted into a repo-local layout skill: read that file before coding
(e.g. angular-developer/SKILL.md when it exists in this skills tree).
