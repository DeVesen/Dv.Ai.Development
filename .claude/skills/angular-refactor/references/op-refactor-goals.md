...
- **Signals vs RxJS** — follow [signal-architecture.md](.claude/skills/angular-developer-extension/references/signal-architecture.md): signals for local/feature state; Observables for real streams; a single boundary when translating.
