...
- [ ] If the repository includes a **portable layout conventions** skill (for example `angular-developer`), should it be applied to the new codebase **explicitly**? (Yes / No / Later.)
