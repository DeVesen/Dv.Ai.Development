...
name: caveman
description: >
  Switches Claude response style to ultra-terse "caveman" mode — drops articles, fillers,
  pleasantries, hedging. Technical substance unchanged. Code unchanged.
  Modes: lite, full, ultra, wenyan, human-terse, machine-dense.
  Stop: "stop caveman" or "normal mode".
  Trigger: /caveman, caveman mode, terse mode, machine-dense, human-terse.
  Opt-out: "stop caveman", "normal mode".
---
