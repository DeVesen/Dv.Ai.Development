...
Dieses Bundle **nicht verwerfen** nach Phase 1 — als Kontext an den Planungs-/Implementierungs-Workflow mitgeben. Spart Wiederholungs-Scouts in Phase 2+.
...
| Workflow | Zuständig |
|----------|-----------|
| Vollständige Sprint-Planung | Superpowers: writing-plans |
| Slice-basierte Implementierung | Superpowers: executing-plans |
