...
name: dev-tooling
description: >
  MCP-Gateway fuer beide Dev-MCPs: dev-mcp (49 Tools: Dateien, Build, Test, Scaffolding,
...
when_to_use: >
  ...
  Build, Test, Scaffolding, Code-Review, Analyse, Metriken.
  Routing-Einstieg wenn unklar ist welcher MCP zu verwenden ist.
  Delegate dann an den passenden Detail-Skill: dev-mcp oder codebase-analyzer.
---

# dev-tooling — MCP-Gateway

Zwei MCP-Server, klare Verantwortlichkeiten. Dieser Skill routet zur richtigen Stelle.
...
**Faustregel:** Lesen · Schreiben · Bauen → `dev-mcp`. Analysieren · Reviewen · Indexieren → `codebase-analyzer`.
...
- Nutzer informieren: MCP aktiv? Exe / Node-Prozess laeuft?
