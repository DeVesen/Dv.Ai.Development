...
description: >
  ...
  MCP-Kanon: codebase-analyzer (Windows-Absolutpfad C:\..., kein /workspace/),
...
**Pfad-Format (verbindlich):**

| MCP | Pfad-Format | Parameter |
|-----|-------------|-----------|
| codebase-analyzer | Windows-Absolutpfad `C:\...` | `projectPath`, `filePath` |
| dev-mcp | Windows-Absolutpfad `C:\...` | `file_path`, `root` |

**VERBOTEN:** `/workspace/`-Präfix, relative Pfade — beide MCPs nutzen Windows-Absolutpfade.
...
5. **Schema-Pflicht:** Parameter exakt wie im MCP-Deskriptor; beide MCPs: Windows-Absolutpfad `C:\...` — kein `/workspace/`.
