...
Ziel-Profil [ado-story-pruefe-agent.md](../../../agents/ado-story-pruefe-agent.md). Aufrufer: [subagent-model-before-task.md](../../../references/subagent-model-before-task.md) — Slugs **nicht** hier duplizieren.
