...
| `## Akzeptanzkriterien`-Block aus Repo neu ableiten | **nein** — bestehenden Block **beibehalten**; nur anlegen wenn Abschnitt **komplett fehlt** (minimal aus `## Story-Bezug`, `## Anforderung` / `## Umsetzung` **ohne** Repo-Lauf) |
