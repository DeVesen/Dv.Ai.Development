...
Ziel-Profil [../../agents/ado-task-pruefe-agent.md](../../agents/ado-task-pruefe-agent.md). Aufrufer: [../../../references/subagent-model-before-task.md](../../../references/subagent-model-before-task.md) — Slugs **nicht** hier duplizieren.
