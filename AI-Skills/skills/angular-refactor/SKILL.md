...
2. **Project skills** — Load as needed:
   - [Angular Developer Extension](../angular-developer-extension/SKILL.md) — structure, standalone, `input()`/`output()`, control flow, migrations, test policy, signal architecture.
   - [Angular Developer](../angular-developer/SKILL.md) — API semantics, TestBed/HTTP/harness mechanics.
...
| Thema | Link |
|-------|------|
| Signal-Architektur (Facades, RxJS-Boundary) | [../angular-developer-extension/references/signal-architecture.md](../angular-developer-extension/references/signal-architecture.md) |
| Testing-Policy (Unit vs Integration, Harnesses) | [../angular-developer-extension/references/testing.md](../angular-developer-extension/references/testing.md) |
