...
See also: [testing policy (reference)](../../angular-developer-extension/references/testing.md) — unit vs integration stance, public API, refactor test stance; TestBed/HTTP/harness mechanics → [Angular Developer](../../angular-developer/SKILL.md).
