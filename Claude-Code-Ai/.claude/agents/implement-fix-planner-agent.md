...
3. [build-log-filter/SKILL.md](../skills/build-log-filter/SKILL.md) — Kette 1–8, Interpretationspflicht
4. [codebase-analyzer/SKILL.md](../skills/codebase-analyzer/SKILL.md)
5. [dev-angular-mcp/SKILL.md](../skills/dev-angular-mcp/SKILL.md) / [dev-dotnet-mcp/SKILL.md](../skills/dev-dotnet-mcp/SKILL.md) — nur bei FE/EF im Fix-Scope
...
Verfügbaren MCP situativ wählen. Default: `codebase-analyzer`. MCP primär; Read/Grep nur bei dokumentiertem `MCP: fallback`:
