...
**Auch laden:** `angular-developer` für tiefere API-Regeln und `.claude/skills/angular-developer/references/migrations.md` für Migration-Tooling.
...
- Nach Migration: `build_angular_project` via dev-angular-mcp ausführen und Compile-Fehler beheben ([op-layout.md](op-layout.md) Tooling).
