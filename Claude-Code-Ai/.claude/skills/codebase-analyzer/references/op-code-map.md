...
**Volume-Mount-Voraussetzung:** Die `.mcp.json` muss `-v "${CLAUDE_PROJECT_DIR:-.}:/workspace:ro"` enthalten. Ohne Mount schlagen alle dateibasierten Tools fehl — dann MCP-Fallback deklarieren und auf Read/Grep ausweichen.
