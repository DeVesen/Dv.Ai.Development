...
2. [implementation-workflow/SKILL.md](../skills/implementation-workflow/SKILL.md)
3. [dev-tooling-mcp/SKILL.md](../skills/dev-tooling-mcp/SKILL.md) — Build/Test-Routing (MCP-First)
4. [codebase-analyzer/SKILL.md](../skills/codebase-analyzer/SKILL.md) — MCP-first vor/während Implementierung
...
7. Bei FE-Slice: [dev-angular-mcp/SKILL.md](../skills/dev-angular-mcp/SKILL.md) · Bei EF/Migrations: [dev-dotnet-mcp/SKILL.md](../skills/dev-dotnet-mcp/SKILL.md)
...
**Hard Stop — MCP nicht erreichbar:** `BLOCKER: [dev-angular-mcp | dev-dotnet-mcp] nicht erreichbar` — stoppen; **kein** stiller Shell-Fallback; erst nach expliziter Nutzerfreigabe: Shell + build-log-filter Schritte 1–8 als Fallback.
...
- Skills nur laden ohne Einhaltung
