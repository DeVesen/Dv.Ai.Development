...
Schreibt **Analyse-Bundle** aus Phase [`analyse`](phase-analyse.md) nach `<workspace-root>/requests/stories/` — **nur dort**, nicht unter Skill-Pfad, `.claude/` oder Code-Unterverzeichnissen.
