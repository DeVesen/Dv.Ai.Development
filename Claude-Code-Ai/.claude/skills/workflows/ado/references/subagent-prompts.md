...
Vorlagen zum Kopieren. Regeln: [SKILL.md](../SKILL.md), `references/subagent-model-before-task.md` (im Projekt).
...
Agent-Typ: ado-story-pruefe-agent. Modell: auto.
...
Agent-Typ: ado-task-pruefe-agent. Modell: auto.
...
Aufgabe:
1. Code-Scout read-only (MCP codebase-analyzer bevorzugt).
