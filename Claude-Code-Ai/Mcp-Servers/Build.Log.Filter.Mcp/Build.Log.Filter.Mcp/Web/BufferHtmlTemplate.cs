namespace Build.Log.Filter.Mcp.Web;
...
internal static class BufferHtmlTemplate
{
    public static string GetHtml() => """
        ...
        <head>
          ...
          <title>build-log-filter — Buffer</title>
          <style>
        ...
        <body>
          ...
          <script>
            ...
            function copyBtn(text) {
              return '<button class="btn-copy" title="In Zwischenablage kopieren" onclick="copyText(this)" data-copy="' + escHtml(text) + '">' + COPY_SVG + '</button>';
            }
                ...
                return `
                  <div class="item${open}" data-id="${escHtml(it.id)}">
                    ...
                    <div class="item-body">
                      ...
                      <div class="section">
                        <div class="section-header"><div class="section-title">Request (Input)</div>${copyBtn(it.inputValue)}</div>
                        <pre>${escHtml(it.inputValue)}</pre>
                      </div>
                      <div class="section">
                        <div class="section-header"><div class="section-title">Output</div>${copyBtn(it.outputValue)}</div>
