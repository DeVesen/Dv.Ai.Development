...
That flow stays in [../ado/SKILL.md](../../ado/SKILL.md) and **ado-agent**: Task-MD sources, Description max. **400** characters, **must** include `Story #{storyId}`.
...
**Trigger-Pflege:** YAML `description` in [../SKILL.md](../SKILL.md) + [../../agents/buddy-agent.md](../../agents/buddy-agent.md) End-Artefakt routing.
