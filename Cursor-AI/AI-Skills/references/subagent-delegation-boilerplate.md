...
3. **MCP-First (alle Phasen):** `.cursor/mcps.md` lesen; MCPs bevorzugt vor Read/Grep einsetzen. Fallback auf Read/Grep nur nach ausgeschöpfter MCP-Kette oder MCP-BLOCKER — mit Begründung dokumentieren. Ausnahme: reine UI-Labels ohne Symbol.
