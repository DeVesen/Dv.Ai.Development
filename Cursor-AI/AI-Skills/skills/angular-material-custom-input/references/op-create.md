# Operation: Neues Custom Input erstellen

Erstellt ein neues Angular Material Custom Input (Shell + Direktive) nach dem Zwei-Schichten-Muster.
...
- Implementiert `MatFormFieldControl<T>` vollständig (siehe [mat-form-field-control-contract.md](mat-form-field-control-contract.md)).
