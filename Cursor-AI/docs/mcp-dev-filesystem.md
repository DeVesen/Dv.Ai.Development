...
> **Agent-Kanon (Pflicht):** [`skills/dev-filesystem-mcp/SKILL.md`](../AI-Skills/skills/dev-filesystem-mcp/SKILL.md) — Tools, Parameter (`file_path`, `root`), JSON-Beispiele, Fehlerdiagnose. Diese Datei ist Menschen-Doku; bei Widersprüchen gilt der Skill.
...
Siehe `packages/dev-filesystem-mcp.json` und Referenz `AI-Skills/mcp.json`.
