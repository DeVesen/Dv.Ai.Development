...
## Teil 2: MCP-First für Build/Test (dev-angular-mcp / dev-dotnet-mcp)
...
| Kommando | Tool | Grund |
|----------|------|-------|
| `ng build`, `ng test` | dev-angular-mcp (MCP-First) | MCP filtert intern |
| `dotnet build`, `dotnet test` | dev-dotnet-mcp (MCP-First) | MCP filtert intern |
...
|-------|-----------------|
| `AI-Skills/rules/dev-tooling-mcp.mdc` | VERBOTEN-Tabelle + Hard Stop Build/Test |
| `AI-Skills/skills/dev-tooling-mcp/SKILL.md` | Build/Test-Routing + VERBOTEN-Block |
| `AI-Skills/rules/build-log-filter.mdc` | MCP-FIRST Sektion + Scope-Ausschluss |
| `AI-Skills/skills/build-log-filter/SKILL.md` | Außer-Scope-Sektion |
| `AI-Skills/skills/implementation-workflow/SKILL.md` | Anti-Shortcut-Regel + MCP-Pflicht-Section |
| `AI-Skills/agents/implement-agent.md` | MCP-Pflicht-Tabelle + Hard Stop |
| `AI-Skills/skills/angular-developer/SKILL.md` | ng build → MCP |
| `AI-Skills/skills/angular-developer/references/op-tooling.md` | Build/Test MCP-Sektion |
| `AI-Skills/skills/dev-angular-mcp/SKILL.md` | Neue Tools + /workspace Pfade |
| `AI-Skills/skills/dev-dotnet-mcp/SKILL.md` | Neue Tools + /workspace Pfade |
| `AI-Skills/references/verification-commands.md` | MCP als Primary Path |
