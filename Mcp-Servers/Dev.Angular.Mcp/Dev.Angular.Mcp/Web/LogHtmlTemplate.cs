...
internal static class LogHtmlTemplate
{
    public static string GetHtml() => """
        ...
        <head>
          ...
          <title>dev-angular-mcp — Log</title>
          <style>
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            header h1 { font-size: 1rem; font-weight: 600; color: #dd0031; white-space: nowrap; }
            ...
            .refresh-toggle input { accent-color: #dd0031; cursor: pointer; }
            .btn-clear {
            ...
            .tag {
              ...
              background: #1e2228; color: #dd0031; white-space: nowrap; flex-shrink: 0;
            }
