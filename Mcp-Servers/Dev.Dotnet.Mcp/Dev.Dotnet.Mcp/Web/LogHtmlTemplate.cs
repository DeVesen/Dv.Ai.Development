...
internal static class LogHtmlTemplate
{
    public static string GetHtml() => """
        ...
        <head>
          ...
          <title>Dev.Dotnet.Mcp — Log</title>
          <style>
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            header h1 { font-size: 1rem; font-weight: 600; color: #512bd4; white-space: nowrap; }
            ...
            .refresh-toggle input { accent-color: #512bd4; cursor: pointer; }
            .btn-clear {
            ...
            .tag {
              ...
              background: #1e2228; color: #512bd4; white-space: nowrap; flex-shrink: 0;
            }
