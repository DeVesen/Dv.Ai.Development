...
## Verhältnis zu `craft-design-principles` und `craft-modulith-thinking`

| Frage | Zuständig |
|-------|-----------|
| Ist das ein System oder Konzern/Tochterunternehmen — mehrere? | `craft-modulith-thinking` |
| Wo verläuft die Kontextgrenze? | DDD — `craft-design-principles` |
| Wird aus der Kontextgrenze eine Prozessgrenze? | Deployment-Achse hier |
| Wie sieht eine Methode innen aus? | IODA/IOSP — `craft-design-principles` |
