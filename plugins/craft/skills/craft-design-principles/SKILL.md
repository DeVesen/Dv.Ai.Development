---
name: craft-design-principles
description: >
  Use when making architecture or design-structure decisions, weighing conflicting
  design principles, structuring classes/functions/components, or reviewing code
  for DDD/IODA/SOLID/Flow-Design conformance. Triggers: meine Prinzipien,
  Design-Philosophie, mein Mantra, DDD, Bounded Context, Aggregate,
  Ubiquitous Language, Orchestrator, Integration vs Operation, IOSP, Flow Design,
  Entwurf vor Code, Component-Hierarchie, welches Prinzip hat Vorrang.
  Opt-out: ohne craft-design-principles.
---
...
Naming-Detailregeln, Comments-Taxonomie, Formatting, Objects/Data-Struktur,
Error-Handling-Mechanik, Smells-Taxonomie → Skill `craft-clean-code`.
...
`ohne craft-design-principles` → Skill nicht laden.
