...
L-01  root: A3 not fully carried — exit status / previous file untouched
      ...
      fixer round 1: closed — "added exit-status wording"
      fixer round 2: closed — "clarified Task 3 done-when"
      fixer round 3: closed — "done-when now states non-zero exit"
      attempts: 3
...
L-06  root: Task 1 fixture file not named
      category other · seen: PR3-07 · fixer round 3: closed · not raised again
      status: done
